  ...
  switch (tenantId) {
    case "mackwash":
      return {
        ...
        custom_brand_notes:
          "Mack Wash — Douglasville GA, soft-wash only, strictly $150/hr.\n\nCLOSE SCRIPT (follow exactly):\n1. Get sqft or size tier.\n2. Price pitch: \"If I can get you on the route I have out in [city] next week, I can do $[price] for the whole house wash, top to bottom — that covers all the siding, trim, soffit and eaves, and the exterior windows and screens.\"\n3. STOP. Let them respond.\n4. On positive or neutral response: \"Does Monday or Tuesday work better for you?\" Always A or B, never open-ended.\n5. On price pushback: review discount first ($20 off for 5-star Google review after job). If still resistant, transport waive ($50 off). Never go below floor.\n6. Day confirmed: \"Perfect — locked you in for [day]. Someone will reach out to confirm the exact time. You are all set.\"\n\nDRIVEWAY RULE: Never quote driveway proactively. If asked: \"We will quote that when we come out — need to measure it, but we will do a bundle deal while we are there.\" Keep closing the house wash.\n\nTone: Direct, confident, assumes the sale. No filler, no open-ended questions except the forced A/B day choice.",
        pricing_locked: 1,
      };
